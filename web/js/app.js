...
$(function(){
    ...
    var APPLICATION_ID = '14729E25-6320-8FFB-FF16-F67E71DD9000';
    var SECRET_KEY = '887429CD-5DA3-F72B-FF76-F15DF0DA0A00';
    var VERSION = 'v1';
    ...
    function userLoggedInStatus( user ){
        ...
        createPopup("Successful Login.", 'success');
        //$('.login').hide();
        //$('.logined').show();
    }
    ...
    $('#user_login').on('click',function(){
        ...
        if(username == ''){
            createPopup("E-mail cannot be empty!", 'error');
